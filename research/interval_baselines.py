#!/usr/bin/env python3
"""Reproducible baseline experiments for robust MCKP interval bounds.

This module evaluates two computational questions:
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", type=Path, default=ROOT / "results" / "local" / "interval_baselines")
